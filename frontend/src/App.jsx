...
function App() {
  ...
  const featuredEvents = [
    {
      id: 0,
      title: "HackData 2026",
      image: "/eventplaceholder.jpg",
      description: "HackData 2026 is a tech event by Shiv Nadar University that brings students together to innovate and compete. It features competitions like coding battles, cybersecurity challenges, and a 24-hour hackathon. Participants collaborate to build real-world solutions while learning from industry experts. Overall, it’s a space for creativity, problem-solving, and hands-on tech experience.",
      date: "Oct 24-26, 2026",
      location: "SNU Campus"
    },
    {
      id: 1,
      title: "Code Clash 2027",
      image: "/eventplaceholder.jpg",
      description: "Code Clash 2027 is an intense algorithmic programming competition. Battle against the brightest minds to solve complex data structures and algorithmic puzzles under extreme time pressure. Forge your legacy in the coding arena!",
      date: "Mar 10-12, 2027",
      location: "Online / SNU Campus"
    },
    {
      id: 2,
      title: "Design Sprint",
      image: "/eventplaceholder.jpg",
      description: "A 48-hour UI/UX marathon where designers race to build the most intuitive and breathtaking interfaces for real-world problems. Bring your creative juices and design the future!",
      date: "Nov 5-7, 2026",
      location: "SNU Campus"
    }
  ];
  ...
  const coreMembers = [
    { name: "Alex Pixel", position: "Guild Master", image: "https://api.dicebear.com/9.x/pixel-art/svg?seed=Alex" },
    { name: "Sam Sprite", position: "Lead Developer", image: "https://api.dicebear.com/9.x/pixel-art/svg?seed=Sam" },
    { name: "Jordan Bit", position: "Creative Director", image: "https://api.dicebear.com/9.x/pixel-art/svg?seed=Jordan" },
    { name: "Casey Byte", position: "Community Manager", image: "https://api.dicebear.com/9.x/pixel-art/svg?seed=Casey" },
    { name: "Riley Code", position: "Lead Designer", image: "https://api.dicebear.com/9.x/pixel-art/svg?seed=Riley" },
    { name: "Taylor Bug", position: "Event Coordinator", image: "https://api.dicebear.com/9.x/pixel-art/svg?seed=Taylor" }
  ];

  const subcoreMembers = Array.from({ length: 12 }, (_, i) => ({
    name: `Player ${i + 1}`,
    position: "Party Member",
    image: `https://api.dicebear.com/9.x/pixel-art/svg?seed=Player${i}`
  }));
    ...
    <div className="bg-[#0d071d] text-white selection:bg-pink-500 selection:text-white overflow-x-hidden w-full relative">
      ...
      <div className="min-h-screen flex flex-col relative overflow-hidden">
        ...
        <motion.div style={{ y: yClouds }} className="absolute inset-x-0 top-[30%] bottom-[10%] pointer-events-none z-0 flex items-center justify-center">
          <img src="/bgclouds2.png" alt="Background Clouds" className="w-full h-full object-cover opacity-60" style={{ imageRendering: 'pixelated' }} />
        </motion.div>

        {/* Background Clouds */}
        <motion.img src="/cloud2.png" alt="" className="absolute top-[12%] xl:top-[20%] -left-4 xl:left-8 w-40 md:w-56 xl:w-72 pointer-events-none z-0" style={{ y: yClouds, imageRendering: 'pixelated' }} />
        <motion.img src="/cloud1.png" alt="" className="absolute top-[30%] xl:top-[10%] -right-4 xl:right-8 w-48 md:w-64 xl:w-80 pointer-events-none z-0" style={{ y: yClouds, imageRendering: 'pixelated' }} />

        {/* Hero Section Center Image */}
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-[5]">
          <img src="/herosectionimage-removebg-preview.png" alt="Hero Background" className="w-[100vw] xl:w-[900px] 2xl:w-[1100px] max-w-none h-auto object-contain opacity-90" style={{ imageRendering: 'pixelated' }} />
        </div>

        {/* Navbar */}
        <header className="flex justify-between items-center p-3 xl:p-6 z-20 relative">
          <div className="flex items-center gap-3">
            <img src="/acm-logo.png" alt="ACM Logo" className="w-12 h-12 md:w-13 xl:w-14 xl:h-14" style={{ imageRendering: 'auto' }} />
            <img src="/logoacnsnioe.png" alt="ACM SNIOE Logo" className="h-8 md:h-14 xl:h-15 w-auto pointer-events-none" style={{ imageRendering: 'pixelated' }} />
          </div>
        ...
        <main className="flex-1 flex flex-col items-center justify-start text-center px-4 z-10 w-full max-w-5xl mx-auto pb-32 xl:pb-28">
          ...
          <div className="mb-2 select-none pt-16 xl:pt-0 flex flex-col items-center">
            <img src="/acmsnioe.png" alt="ACM SNIOE Title" className="w-[300px] md:w-[380px] xl:w-[480px] h-auto mb-2 pointer-events-none" style={{ imageRendering: 'pixelated' }} />
          </div>
          ...
          <div className="flex flex-col items-center w-full mt-auto z-10">
            ...
            <div className="relative inline-flex items-center justify-center -rotate-[2deg] mb-1 cursor-pointer">
              <img src="/white.png" alt="Everybody's Pill bg" className="w-[260px] md:w-[340px] xl:w-[420px] h-auto pointer-events-none" style={{ imageRendering: 'pixelated' }} />
            ...
            <div className="flex flex-wrap gap-4 justify-center w-full">
              <a href="#events" className="relative inline-flex items-center justify-center cursor-pointer hover:scale-105 active:scale-95 transition-transform">
                <img src="/pink.png" alt="Pink button bg" className="w-[160px] md:w-[200px] xl:w-[240px] h-auto pointer-events-none" style={{ imageRendering: 'pixelated' }} />
              ...
              <a href="#team" className="relative inline-flex items-center justify-center cursor-pointer hover:scale-105 active:scale-95 transition-transform">
                <img src="/purple.png" alt="Purple button bg" className="w-[160px] md:w-[200px] xl:w-[240px] h-auto pointer-events-none" style={{ imageRendering: 'pixelated' }} />
        ...
        <img src="/boombox.png" alt="Boombox" className="absolute left-2 xl:left-5 bottom-[2.9rem] md:bottom-[2.6rem] lg:landscape:bottom-[2.3rem] xl:landscape:bottom-[3.8rem] 2xl:landscape:bottom-[3.3rem] w-20 md:w-32 xl:w-52 -rotate-[1.5deg] z-30 pointer-events-none origin-bottom" style={{ imageRendering: 'pixelated' }} />
        {/* Gengar Standing on Footer */}
        <img src="/gengar.png" alt="Gengar" className="absolute right-2 xl:right-6 bottom-[3.2rem] md:bottom-[3.4rem] lg:landscape:bottom-[3.6rem] xl:landscape:bottom-[5.2rem] 2xl:landscape:bottom-[5.7rem] w-20 md:w-32 xl:w-48 -rotate-[5.5deg] z-30 pointer-events-none origin-bottom" style={{ imageRendering: 'pixelated' }} />
          ...
          <motion.div style={{ opacity: fadeOutMission }}>
            ...
            >
              <h3 className="font-pixelify text-2xl md:text-3xl text-white mb-4 drop-shadow-[1px_1px_0_rgba(0,0,0,0.8)] flex items-center gap-3">
                Our Mission
                <img src="/usb.png" alt="USB" className="w-8 md:w-12 h-auto" style={{ imageRendering: 'pixelated' }} />
              </h3>
            ...
            >
              <img src="/arrows.png" alt="Scroll Down" className="w-26 md:w-46 h-auto animate-bounce opacity-90 pt-8 md:pt-12 pb-2 md:pb-6" style={{ imageRendering: 'pixelated' }} />
            </motion.div>
          </motion.div>
      ...
      <div id="events" className="min-h-screen flex flex-col relative overflow-hidden items-center justify-start text-center pt-2 px-4 pb-4">
        ...
        <div className="absolute bottom-[22vh] md:bottom-[21rem] lg:bottom-[32.5rem] lg:landscape:bottom-[12vh] xl:bottom-[11.25rem] xl:landscape:bottom-[11.25rem] inset-x-0 w-full h-[30vh] md:h-[30vh] lg:landscape:h-[40vh] xl:h-[50vh] xl:landscape:h-[50vh] pointer-events-none z-0 flex items-end">
          <img src="/bgblocks.png" alt="Ground blocks" className="w-full h-full object-cover object-top opacity-100" style={{ imageRendering: 'pixelated' }} />
        </div>

        {/* Global Clouds for Page 3 */}
        <motion.img src="/cloud2.png" alt="Cloud" className="absolute left-4 xl:left-12 top-18 xl:top-20 w-24 md:w-40 xl:w-60 opacity-90 pointer-events-none z-0" style={{ imageRendering: 'pixelated' }} />
        <motion.img src="/cloud1.png" alt="Cloud" className="absolute right-0 xl:right-12 bottom-[20vh] md:bottom-[26vh] lg:bottom-[36vh] xl:bottom-[75vh] w-32 md:w-48 xl:w-56 opacity-90 pointer-events-none z-0" style={{ imageRendering: 'pixelated' }} />
        ...
        <div className="relative w-[105vw] max-w-[105vw] md:w-[105vw] md:max-w-[105vw] xl:w-full xl:max-w-[1500px] flex items-center justify-center z-10 -mt-[5.5rem] md:-mt-[5.5rem] xl:mt-[-8rem] mb-0 xl:mb-[-6rem]">
          <img src="/parchment.png" alt="Parchment Board" className="w-full h-[650px] md:h-[750px] xl:h-auto object-fill xl:object-contain drop-shadow-[0_20px_50px_rgba(0,0,0,0.8)]" style={{ imageRendering: 'pixelated' }} />
              ...
              >
                ...
                <div className="flex flex-col items-center flex-1 max-w-md w-full shrink-0">
                  ...
                  <div className="w-[85%] md:w-[94%] xl:w-full rounded-xl overflow-hidden border-[4px] border-[#3b2d1d] shadow-[4px_4px_0_rgba(59,45,29,0.8)] pointer-events-none">
                    <img src={currentEvent.image} alt={currentEvent.title} className="w-full h-auto object-cover" />
                  </div>
                </div>
                ...
                <div className="flex flex-col flex-1 text-[#3b2d1d] items-center w-full">
                  ...
                  <div className="flex justify-center w-full mt-4 gap-2">
                    <img onClick={handlePrevEvent} src="/arrow_0.png" alt="Previous Event" className="h-10 md:h-16 w-auto cursor-pointer hover:scale-110 active:scale-95 transition-transform drop-shadow-[2px_2px_0_rgba(0,0,0,0.2)]" style={{ imageRendering: 'pixelated' }} />
                    <img onClick={handleNextEvent} src="/arrow_1.png" alt="Next Event" className="h-10 md:h-16 w-auto cursor-pointer hover:scale-110 active:scale-95 transition-transform drop-shadow-[2px_2px_0_rgba(0,0,0,0.2)]" style={{ imageRendering: 'pixelated' }} />
                  </div>
                </div>
              </motion.div>
            </AnimatePresence>
              ...
              >
                ...
                <div className="flex flex-col flex-1 text-[#3b2d1d] items-start -mt-2 2xl:-mt-6">
                  ...
                  <div className="flex justify-end w-full mt-4 gap-0 pr-12 2xl:pr-0">
                    <img onClick={handlePrevEvent} src="/arrow_0.png" alt="Previous Event" className="h-12 2xl:h-16 w-auto cursor-pointer hover:scale-110 active:scale-95 transition-transform drop-shadow-[2px_2px_0_rgba(0,0,0,0.2)]" style={{ imageRendering: 'pixelated' }} />
                    <img onClick={handleNextEvent} src="/arrow_1.png" alt="Next Event" className="h-12 2xl:h-16 w-auto cursor-pointer hover:scale-110 active:scale-95 transition-transform drop-shadow-[2px_2px_0_rgba(0,0,0,0.2)]" style={{ imageRendering: 'pixelated' }} />
                  </div>
                </div>
              </motion.div>
            </AnimatePresence>
        ...
        <div className="z-30 -mt-[6.5rem] md:-mt-32 xl:-mt-24 mb-4 xl:mb-8 flex flex-col items-center -rotate-[3deg]">
          <div className="relative inline-flex items-center justify-center cursor-pointer hover:scale-105 active:scale-95 transition-transform duration-200">
            <img src="/viewquest.png" alt="View Quests Button" className="w-[200px] md:w-[300px] xl:w-[360px] h-auto pointer-events-none" style={{ imageRendering: 'pixelated' }} />
          </div>
      ...
      <div className="min-h-screen relative flex flex-col items-center justify-between pt-16 md:pt-24 pb-12 text-white z-20 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none z-0 flex items-center justify-center opacity-40">
          <img src="/bgclouds2.png" alt="Background Clouds" className="w-full h-full object-cover" style={{ imageRendering: 'pixelated' }} />
        </div>
        ...
        <motion.img
          ...
          src="/cloud1.png" alt="Cloud" className="absolute top-[15%] -left-10 md:left-6 w-40 md:w-72 pointer-events-none z-0" style={{ imageRendering: 'pixelated' }}
        />
        <motion.img
          initial={{ x: 50, opacity: 0 }}
          whileInView={{ x: 0, opacity: 0.8 }}
          transition={{ duration: 1.5, delay: 0.3, ease: "easeOut" }}
          src="/cloud2.png" alt="Cloud" className="absolute top-[50%] -right-10 md:right-20 w-48 md:w-80 pointer-events-none z-0" style={{ imageRendering: 'pixelated' }}
        />
        ...
        <div className="absolute top-[40%] md:top-[61%] left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none z-[5]">
          <motion.img
            ...
            src="/moon_and_clouds.png" alt="Moon and Clouds" className="w-[120px] md:w-[300px] h-auto" style={{ imageRendering: 'pixelated' }}
          />
        </div>
        ...
        >
          <img src="/acmsnioe.png" alt="ACM SNIOE Logo" className="w-[300px] md:w-[600px] h-auto pointer-events-none drop-shadow-[0_0_30px_rgba(255,140,190,0.2)] hover:scale-105 transition-transform duration-500" style={{ imageRendering: 'pixelated' }} />
        </motion.div>
